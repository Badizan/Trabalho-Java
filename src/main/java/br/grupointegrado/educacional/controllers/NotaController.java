...
public class NotaController {
    ...
    // PUT para atualizar uma nota existente
    @PutMapping("/{idNota}")
    public ResponseEntity<Nota> updateNota(@PathVariable Integer idNota, @RequestBody NotaRequestDTO dto) {
        Nota nota = this.notaRepository.findById(idNota)
        ...
        return ResponseEntity.status(HttpStatus.OK).body(updatedNota);
    }
}
